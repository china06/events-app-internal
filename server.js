...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'somewhere', likes: 0 },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'somewhere', likes: 0 }
    ]
};
